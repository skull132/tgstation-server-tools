...
namespace TGControlPanel
{
	partial class Main
	{
		...
		private void FullUpdateWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			{
				case FullUpdateAction.Testmerge:
					updateError = Updater.UpdateServer(TGRepoUpdateMethod.None, false, (ushort)testmergePR, false);
					break;
				case FullUpdateAction.UpdateHard:
					updateError = Updater.UpdateServer(TGRepoUpdateMethod.Hard, true, 0, true);
					break;
				case FullUpdateAction.UpdateHardTestmerge:
					updateError = Updater.UpdateServer(TGRepoUpdateMethod.Hard, true, (ushort)testmergePR, true);
					break;
				case FullUpdateAction.UpdateMerge:
					updateError = Updater.UpdateServer(TGRepoUpdateMethod.Merge, true, (ushort)testmergePR, true);
					break;
				case FullUpdateAction.Reset:
					updateError = Updater.UpdateServer(TGRepoUpdateMethod.Reset, false, 0, false);
					break;
			}
		}
